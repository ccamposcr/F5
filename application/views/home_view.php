    <div id="divContent">
        ...
        <div id="divContentButtons" class="clearfix">
            <div id="divButton1">
                <a href="<?php echo base_url(); ?>escazu/1/reservaciones"><img id="imgLogoBoton1" src="<?php echo base_url(); ?>img/f5-escazu-button.png" alt="F5" height="98" width="198"></a>
            </div>
             <div id="divButton2">
                <a href="<?php echo base_url(); ?>desamparados/1/reservaciones"><img id="imgLogoBoton2" src="<?php echo base_url(); ?>img/f5-escazu-button.png" alt="F5" height="98" width="198"></a>
            </div>
