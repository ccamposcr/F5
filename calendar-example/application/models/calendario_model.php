...
class Calendario_model extends CI_MODEL
{
	...
	public function __construct()
    {
        ...
        //date entre los enlaces de la cabecera
    ...
    //cogemos los datos de la tabla reservations y la colocamos en cada día
    //del calendario
    public function get_datos_calendario($year, $month)
    {
        ...
        foreach ($query->result() as $row) 
        {
            ...
            //encontrado en la date es un cero, es decir, los días 
            ...
            //datos calendario contiene la fila del comment del evento de ese día
            $datos_calendario[$index] = $row->comment;
    ...
    public function insert_calendario($date, $comment)
    {
        $data = array(
            'date' => $date,
            'comment' => $comment
